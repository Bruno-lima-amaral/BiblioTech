...
export default function PaginaLogin() {
  ...
  <div
    ...
    style={{
      backgroundImage: "url('https://images.unsplash.com/photo-1764406807567-a24faaaad034?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBsaWJyYXJ5JTIwaW50ZXJpb3IlMjBhcmNoaXRlY3R1cmFsfGVufDF8fHx8MTc3NTMxNjg4NXww&ixlib=rb-4.1.0&q=80&w=1080')",
      backgroundSize: "cover",
      backgroundPosition: "center",
    }}
  >
    {/* Overlay azul navy semitransparente */}
    ...
    <div className="relative z-10 w-full max-w-md space-y-8">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight text-white">BiblioTech</h1>
      ...
      <form
        ...
        className="space-y-5 rounded-xl border border-white/10 bg-white/10 backdrop-blur-md p-6 shadow-sm"
      >
        {/* Campo de e-mail */}
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="h-10 w-full rounded-lg border border-white/20 bg-white/10 pl-10 pr-4 text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-white/30"
            />
          </div>
        </div>
        ...
        {/* Campo de senha */}
        <div className="space-y-2">
          <label htmlFor="login-senha" className="text-sm font-medium text-white">
            Senha
          </label>
          <div className="relative">
      ...
      <div className="text-center space-y-2">
        <p className="text-sm text-white/60">
          ...
          <Link
            ...
            className="font-medium text-white underline underline-offset-4 hover:opacity-80 transition-opacity"
          >
            Recuperar Senha
          </Link>
        </p>
